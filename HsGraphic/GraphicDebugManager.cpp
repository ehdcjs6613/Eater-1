...
{
	Create_3D_Box_Buffers(XMFLOAT3(0, 0, 0), XMFLOAT3(0.25f, 0.25f, 0.25f));
	Create_2D_Line_Buffers(XMFLOAT3(0, 0, 0), XMFLOAT3(0, 0, -0.5f), XMFLOAT3(1, 0, 0));
	Create_2D_Line_Buffers(XMFLOAT3(0, 0, 0), XMFLOAT3(0, 0.5f, 0), XMFLOAT3(0, 1, 0));
	Create_2D_Line_Buffers(XMFLOAT3(0, 0, 0), XMFLOAT3(0.5f, 0, 0), XMFLOAT3(0, 0, 1));
